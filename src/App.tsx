        ...
        <div className="help-layout">
          ...
          <div className="help-content">
            ...
            {section === "history" && (
              <div className="help-section">
                <h3>更新履歴</h3>
                <article className="release-card"><div><strong>{APP_VERSION}</strong><span>表示フォントの改善</span></div><ul><li>Noto Sans JPを優先して使用するフォント構成へ変更</li><li>Noto Sans JPがない環境では従来のWindows向けフォントへ自動的に切り替え</li></ul></article>
